...
const UNPLEASANT_FEELINGS: Feeling[] = [
  ...
  { name: "Helpless", description: "I feel like I can't do anything to change it, even if I want to." },
  { name: "Confused", description: "I feel mixed up and unsure what's true or what to do next." },
  { name: "Bored", description: "I feel unstimulated, like nothing feels interesting right now." },
  { name: "Indifferent", description: "I feel like I don't really care, like it doesn't matter to me much." },
  { name: "Resigned", description: "I feel like I've stopped fighting it, and I'm just going along with it." },
  { name: "Impatient", description: "I feel like I want it to happen now, and waiting feels really hard." },
  { name: "Indignant", description: "I feel upset because something feels unfair or wrong, and it shouldn't be that way." },
  { name: "Regretful", description: "I feel bad about what I did or didn't do, and I wish I could change it." },
  { name: "Despairing", description: "I feel like nothing will get better, and I don't see a way forward." },
  { name: "Exhausted", description: "I feel drained and tired, like I don't have the energy to keep going." },
  { name: "Nervous", description: "I feel jittery and on edge, like something might happen and I can't relax." },
  { name: "In Pain", description: "I feel real pain inside or in my body, and it's hard to ignore." },
  { name: "Oppressed", description: "I feel weighed down, like something is pressing on me and I can't breathe freely." },
];
